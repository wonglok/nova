...
export const ThisTableName = Table.AppCodeFile.tableName;
    ...
    await ddb.send(
      new PutItemCommand({
        ...
        Item: marshall({
          ...
          packageOID: reqBodyJson.packageOID,
          moduleOID: reqBodyJson.moduleOID,

          //
          fileName: reqBodyJson.fileName || "app.js",
          content: reqBodyJson.content || "",
